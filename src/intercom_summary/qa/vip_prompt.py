...
vip-greet-personal | The agent's first message contains no greeting, or the player's name is shown in the chat but the agent never used it | −4 | name not visible
